...
plot(x$DT, x$Global_active_power, ylab = "Global Active Power",
     type = "l", xlab = "", main = "")

plot(x$DT, x$Voltage, ylab = "Voltage", 
     type="l", xlab="date/time")

plot(x$DT, x$Global_active_power, ylab = "Energy sub metering", 
     type="l", xlab="")
...
plot(x$DT, x$Global_reactive_power, 
